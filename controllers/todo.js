const moment = require("moment")   //refer moment.js website to get formats
...
const addTodoFomeController = (req,res,next)=>{
    try {
...
const addTodoController = async(req,res,next)=>{
    try {
        ...
        await newTodo.save()
        res.redirect("/")                  // "/" means home route (app.get)
    } catch (error) {
